            ...
            <div className="col-md-6 col-lg-4">
              <div className="row">
                ...
                <div className="col-12">
                  <div className="single__contact">
                    <div className="contact__icon">
                      <svg width={40} height={55} viewBox="0 0 46 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <div className="col-12">
                  <div className="single__contact">
                    ...
                    <div className="contact__text">
                      ...
                      <div className="contact__email">
                        <p>
                          <a href="tel:9830721610" style={{ color: "#000", fontWeight: "bold" }}>
                            +91 9830721610
                          </a>
                        </p>
                      </div>
                ...
                <div className="container">
                  <div className="row">
                    <div className="col-xl-12 align-items-center">
                      <div className="contact__form__inner" style={{ boxShadow: "0px 4px 25px rgba(174, 181, 206, 0.3" }}>
                        <form id="contact-form" className="contact-form" action="https://html.themewin.com/edurock-preview/edurock/mail.php" method="post">
                          <div className="row">
                            ...
                            <div className="col-xl-12" data-aos="fade-up">
                              <div className="contact__input__wraper">
                                <textarea name="con_message" id="con_message" style={{ height: 120 }} placeholder="Enter Your Message here" defaultValue={""} />
                                <div className="contact__icon">
