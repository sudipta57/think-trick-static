            ...
            <form id="contact-form" className="contact-form" action="https://html.themewin.com/edurock-preview/edurock/mail.php" method="post">
              <div className="row">
                ...
                <div className="col-xl-12" data-aos="fade-up">
                  <div className="contact__input__wraper">
                    <textarea name="con_message" id="con_message" cols={30} rows={10} placeholder="Enter Your Message here" defaultValue={""} />
                    <div className="contact__icon">
                ...
                <div className="col-xl-12" data-aos="fade-up">
                  <div className="contact__button">
                    <button type="submit" value="submit" className="default__button" name="submit">Post a Comment</button>
