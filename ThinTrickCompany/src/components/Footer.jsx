                ...
                <div className="footerarea__inner">
                  ...
                  <div className="footerarea__list">
                    <ul>
                      ...
                      <li>
                        <a href="#">Graphics And Logo Design </a>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="footerarea__inner footerarea__padding__left">
                  ...
                  <div className="footerarea__list">
                    <ul>
                      ...
                      <li>
                        <iframe
                          src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1119.7535249653952!2d88.1815273!3d21.8660114!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a02556b781a8369%3A0xacd131f109615e69!2sTECHNO%20SYSTEMS!5e1!3m2!1sen!2sin!4v1717931264900!5m2!1sen!2sin"
                          width={"100%"}
                          height={150}
                          style={{ border: 0 }}
                          allowFullScreen
            ...
            <div className="row">
              ...
              <div className="col-xl-6 col-lg-6">
                <div className="footerarea__copyright__content footerarea__copyright__content__2">
                  <p>
                    Copyright © <span>2024</span> by Think-Trick. All Rights
                    Reserved.
                  </p>
                </div>
              </div>
