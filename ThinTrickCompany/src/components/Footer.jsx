      ...
      <div className="row">
        ...
        <div className="col-xl-3 col-lg-3">
          <div className="footerarea__icon footerarea__icon__2">
            <ul>
              <li><a href="http://facebook.com/"><i className="icofont-facebook" /></a></li>
              <li><a href="http://twitter.com/"><i className="icofont-twitter" /></a></li>
              <li><a href="http://vimeo.com/"><i className="icofont-vimeo" /></a></li>
              <li><a href="http://linkedin.com/"><i className="icofont-linkedin" /></a></li>
              <li><a href="http://skype.com/"><i className="icofont-skype" /></a></li>
            </ul>
          </div>
        </div>
      </div>
