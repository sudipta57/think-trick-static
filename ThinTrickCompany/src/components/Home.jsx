      ...
      <main class="main_wrapper overflow-hidden">
        <div className="herobannerarea herobannerarea__box">
                ...
                <div className="herobannerarea__content__wraper">
                  <div className="herobannerarea__title">
                    ...
                    <div className="herobannerarea__title__heading__2">
                      <h2>Best IT Services For Your Business</h2>
                    </div>
                  </div>
              ...
              <p>Lorem Ipsum is simply dummy text of the printing typesetting industry. Lorem Ipsum
                has been </p>
                  ...
                  <div className="hreobannerarea__button">
                    <a className="herobannerarea__button__1" href="#">View Courses</a>
                    <a className="herobannerarea__button__2" href="#">Find out more
              ...
              <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                <div className="aboutarea__img__inner text-center">
                  <div className="aboutarea__img" data-tilt>
                    <img loading="lazy" className="aboutimg__1" src="img/about/about_8.png" alt="aboutimg" />
                    <img loading="lazy" className="aboutimg__2" src="img/about/about_1.png" alt="aboutimg" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="herobannerarea__icon">
            <img loading="lazy" className="hero__icon__1" src="img/register/register__2.png" alt="photo" />
            <img loading="lazy" className="hero__icon__2" src="img/herobanner/herobanner__6.png" alt="photo" />
            <img loading="lazy" className="hero__icon__3" src="img/herobanner/herobanner__7.png" alt="photo" />
            <img loading="lazy" className="hero__icon__4" src="img/herobanner/herobanner__7.png" alt="photo" />
          </div>
        </div>
                    ...
                    <div className="single__service">
                      <div className="service__img">
                        ...
                        <div className="service__bg__img">
                          <svg className="service__icon__bg" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M63.3775 44.4535C54.8582 58.717 39.1005 53.2202 23.1736 47.5697C7.2467 41.9192 -5.18037 32.7111 3.33895 18.4477C11.8583 4.18418 31.6595 -2.79441 47.5803 2.85105C63.5011 8.49652 71.8609 30.2313 63.3488 44.4865L63.3775 44.4535Z" fill="#5F2DED" fillOpacity="0.05" />
                          </svg>
                        </div>
                      </div>
                      ...
                      <div className="service__small__img">
                        <svg className="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M16.5961 10.265L19 1.33069L10.0022 3.73285L1 6.1306L7.59393 12.6627L14.1879 19.1992L16.5961 10.265Z" stroke="#FFB31F" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                      </div>
                    </div>
                    <div className="single__service">
