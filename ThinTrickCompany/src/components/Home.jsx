                ...
                <div className="aboutarea__content__wraper">
                  ...
                  <div className="aboutarea__para aboutarea__para__2">
                    <p style={{ color: "#000", fontWeight: "bold" }}>
                      We have a goal to provide Top Notch IT Services and
                      Digital Marketing services to each and every business. No
                      brand or business should remain invisible in this
                      tech-driven market and must be there in front of the whole
                      world. Since our establishment, we served numerous clients
                      and satisfied them with our world-class solutions. From
                      simple website designing to complete digital marketing
                      solutions, we are here to meet your business needs.
                    </p>
                  </div>
              ...
              <div className="col-xl-6 col-md-6 col-sm-12 col-12 our-mission-sec">
                <div className="in-sec">
                  <div className="aboutarea__list__2">
                    ...
                    <ul>
                      <li>
                        Our mission is to grow and prosper as one of the
                        renowned names in the field of technology and digital
                        marketing with the right strategies. We together with
                        our client want to conquer the market with a phenomenal
                        online presence. The tailored-made services are purely
                        dedicated to meeting various IT services Digital
                        Marketing solutions. Helping and supporting our clients
                        to recognize the worth of their business and providing
                        them with the perfect solutions.
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="col-xl-6 col-md-6 col-sm-12 col-12 our-vission-section">
                <div className="in-sec">
                  <div className="aboutarea__list__2">
                    ...
                    <ul>
                      <li>
                        Our vision is to experience confidence and be trusted by
                        the clients as one of the reputed web development
                        companies. We want to fulfill the dream of every
                        business and brand of being successful in the digital
                        era.
                      </li>
                    </ul>
                  </div>
              ...
              >
                ...
                <div className="populerarea__content__wraper__2">
                  ...
                  <div className="populerarea__content__2">
                    <p
                      className="populerarea__para__1"
                      style={{ color: "#000" }}
                    >
                    ...
                    <p
                      className="populerarea__para__2"
                      style={{ color: "#000" }}
                    >
                      Construction is a general term meaning the art and science
                      to form systems organizations, and comes from Latin
                  ...
                  >
                    <div className="single__service">
                      ...
                      <div className="service__content service__content__2">
                        ...
                        <p>
                          Software development requires a range of skills and
                          expertise, including programming languages…{" "}
                        </p>
                      </div>
                    ...
                    <div className="single__service">
                      ...
                      <div className="service__content service__content__2">
                        ...
                        <p>
                          At present, web presence is not an option but a
